...
use SimpleSAML\XSD\XML\xsd\XsInclude;

use function dirname;
use function strval;

/**
 * Tests for xs:include
 *
 * @package simplesamlphp/xml-xsd
 */
#[Group('xs')]
#[CoversClass(XsInclude::class)]
...
final class IncludeTest extends TestCase
{
    ...
    {
        self::$testedClass = XsInclude::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/include.xml',
        );
    }
    ...
    /**
     * Test creating an Include object from scratch.
     */
