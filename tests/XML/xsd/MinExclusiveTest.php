...
/**
 * Tests for xsd:minExclusive
 *
 * @package simplesamlphp/xml-xsd
 */
#[Group('xsd')]
#[CoversClass(MinExclusive::class)]
#[CoversClass(AbstractFacet::class)]
#[CoversClass(AbstractAnnotated::class)]
#[CoversClass(AbstractOpenAttrs::class)]
#[CoversClass(AbstractXsdElement::class)]
final class MinExclusiveTest extends TestCase
{
    ...
    {
        self::$testedClass = MinExclusive::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/minExclusive.xml',
        );
    }
    ...
    public function testMarshalling(): void
    {
        ...
        $minExclusive = new MinExclusive('dummy', true, $annotation, 'phpunit_minexclusive', [$attr4]);
