...
use SimpleSAML\XSD\XML\xsd\AbstractLocalSimpleType;
...
/**
 * Tests for xs:simpleType (xs:localSimpleType)
 *
 * @package simplesamlphp/xml-xsd
 */
#[Group('xs')]
#[CoversClass(LocalSimpleType::class)]
#[CoversClass(AbstractLocalSimpleType::class)]
#[CoversClass(AbstractSimpleType::class)]
#[CoversClass(AbstractAnnotated::class)]
#[CoversClass(AbstractOpenAttrs::class)]
#[CoversClass(AbstractXsdElement::class)]
final class LocalSimpleTypeTest extends TestCase
{
    ...
    {
        self::$testedClass = LocalSimpleType::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/localSimpleType.xml',
        );
    }
