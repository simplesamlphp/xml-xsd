...
final class MinLengthTest extends TestCase
{
    ...
    {
        self::$testedClass = MinLength::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/minLength.xml',
        );
    }
    ...
    /**
     * Test creating an MinLength object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $minLength = new MinLength('dummy', true, $annotation, 'phpunit_minlength', [$attr4]);
