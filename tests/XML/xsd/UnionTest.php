...
use SimpleSAML\XML\Type\{AnyURIValue, IDValue, NCNameValue, NonNegativeIntegerValue, StringValue, QNameValue};
...
use SimpleSAML\XSD\XML\xsd\Union;
...
final class UnionTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/union.xml',
        );
    }
    ...
    public function testMarshalling(): void
    {
        ...
        $simpleType1 = new LocalSimpleType(
            new Restriction(
                ...
                QNameValue::fromString('{http://www.w3.org/2001/XMLSchema}xsd:token'),
            ),
        );
        ...
        $simpleType2 = new LocalSimpleType(
            new XsList(
                null,
                QNameValue::fromString('{http://www.w3.org/2001/XMLSchema}xsd:typeDerivationControl'),
            ),
        );
