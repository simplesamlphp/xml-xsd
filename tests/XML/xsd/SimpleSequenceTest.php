...
use SimpleSAML\XSD\XML\xsd\AbstractExplicitGroup;
use SimpleSAML\XSD\XML\xsd\AbstractOpenAttrs;
use SimpleSAML\XSD\XML\xsd\AbstractSimpleExplicitGroup;
...
use SimpleSAML\XSD\XML\xsd\SimpleSequence;
...
final class SimpleSequenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/simpleSequence.xml',
        );
    }
