...
use SimpleSAML\XSD\XML\xsd\AbstractComplexRestrictionType;
...
use SimpleSAML\XSD\XML\xsd\ComplexRestriction;
 ...
 */
#[Group('xs')]
#[CoversClass(ComplexRestriction::class)]
#[CoversClass(AbstractComplexRestrictionType::class)]
#[CoversClass(AbstractRestrictionType::class)]
#[CoversClass(AbstractAnnotated::class)]
#[CoversClass(AbstractOpenAttrs::class)]
#[CoversClass(AbstractXsdElement::class)]
final class ComplexRestrictionTest extends TestCase
{
    ...
    {
        self::$testedClass = ComplexRestriction::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/complexRestriction.xml',
        );
    }
