...
use SimpleSAML\XSD\XML\xsd\AbstractAttributeGroup;
use SimpleSAML\XSD\XML\xsd\AbstractReferencedAttributeGroup;
...
final class ReferencedAttributeGroupTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/referencedAttributeGroup.xml',
        );
    }
    ...
    public function testMarshalling(): void
    {
        ...
        $attributeGroup = new ReferencedAttributeGroup(
            QNameValue::fromString("{http://www.w3.org/2001/XMLSchema}xsd:occurs"),
            $annotation,
