...
use SimpleSAML\XSD\XML\xsd\AbstractNoFixedFacet;
...
final class PatternTest extends TestCase
{
    ...
    {
        self::$testedClass = Pattern::class;

        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/pattern.xml',
        );
    }
    ...
    /**
     * Test creating a Pattern object from scratch.
     */
    public function testMarshalling(): void
    {
        ...
        $pattern = new Pattern('dummy', $annotation, 'phpunit_pattern', [$attr4]);
